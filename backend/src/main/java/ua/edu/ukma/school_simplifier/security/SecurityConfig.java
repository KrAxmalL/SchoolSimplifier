...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/markBooks*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/dateTopics*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/api/dateTopics*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/dateMarkRecords*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/api/dateMarkRecords*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/namedTopics*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/api/namedTopics*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/namedMarkRecords*").hasAuthority("TEACHER");
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/api/namedMarkRecords*").hasAuthority("TEACHER");
        ...
        http.authorizeRequests().antMatchers(HttpMethod.PATCH, "/api/students*").hasAuthority("HEAD_TEACHER");
